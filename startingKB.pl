...
game("terra mystica",2,5,4,105,12,3.95,["Strategy"],70,false,false,["Civilization", "Economic", "Fantasy", "Territory Building"]).
game("the castles of burgundy",2,4,2,60,12,3.02,["Strategy"],40,false,false,["Dice","Medieval","Territory Building"]).
game("war of the ring (second edition)",2,4,2,165,14,4.06,["Thematic","Wargame"],80,false,true,["Adventure","Fantasy","Novel-Based","Territory Building"]).
